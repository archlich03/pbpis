        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <h3 class="text-xl font-semibold mt-8 mb-4">Meetings</h3>
                    <table class="w-full mt-4">
                        <thead class="text-gray-800 dark:text-gray-200">
                            <tr>
                                <th class="px-4 py-2">Meeting date</th>
                                <th class="px-4 py-2">Meeting type</th>
                                <th class="px-4 py-2">Status</th>
                                <th class="px-4 py-2">Secretary</th>
                                <th class="px-4 py-2">Vote start</th>
                                <th class="px-4 py-2">Vote end</th>
