    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            @if(Auth::user()->role === 'Balsuojantysis')
                ...
                <select id="role" name="role" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full" disabled>
    ...
    <div class="mt-10 pt-6 border-t border-gray-200">
        ...
        @if(empty($user->ms_id))
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                ❌ {{ __('To connect your Microsoft account, log out and then log in using the Microsoft option.') }}
            </p>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                {{ __('Your Microsoft account email must match your current account email.') }}
            </p>
        @else
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
