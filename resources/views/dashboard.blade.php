@section('title', __('Dashboard') . ' - ' . config('app.name', 'PBPIS'))
                ...
                <details>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 p-4 rounded shadow">
                        @foreach ($bodies as $body)
                            <div class="p-3 mb-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200">
                                <a href="{{ route('bodies.show', $body) }}" class="block text-gray-800 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200">
                                    <h2 class="text-xl font-semibold mb-1">{{ $body->title }} ({{ $body->is_ba_sp ? 'BA' : 'MA' }})</h2>
                                    <p class="text-sm text-gray-600 dark:text-gray-400">
                                        {{ __('View') }}
                                    </p>
                                </a>
